 ...
 * Generated at: 2017-11-22 10:18:28 UTC
...
public final class devicecode_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("        <script type=\"text/javascript\" src=\"/js/page/devicecode.js\"></script>\n");
      out.write("\t</head>\n");
      out.write("\t<script>\n");
      out.write("   　    var user = \"");
      ...
      out.write("\t\t\t\t\t\t\t\t<a href=\"#\"><i class=\"icon-qrcode\"></i>设备码生成</a>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      ...
      out.write("                        <p>为设备生成接入系统的唯一凭证.</p>\n");
      out.write("                        <a id = \"toggle-a\" href=\"#new-device-code\" class=\"btn btn-primary\"><i class=\"icon-plus icon-white\"></i>为租户创建设备码</a>\n");
      out.write("                    </div>\n");
      out.write("                    <div id=\"new-device-code\" class=\"form-horizontal hidden\">\n");
      out.write("                    <form id = \"code-gen-form\" action=\"/device/gen-dcode\">\n");
      out.write("\t\t\t\t\t\t<fieldset>\n");
      out.write("\t\t\t\t\t\t\t<legend>New Project</legend>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"control-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"control-label\" for=\"input01\">数量</label>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"controls\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"input-xlarge\" id=\"input01\" name = \"num\"/>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"control-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"control-label\" for=\"select01\">租户</label>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"controls\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<select id=\"select01\" style=\"width:285px\" name= \"uid\"></select>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</fieldset>\n");
      out.write("\t\t\t\t\t</form>\n");
