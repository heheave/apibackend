 ...
 * Generated at: 2017-11-22 10:41:27 UTC
...
public final class appAdd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("        <script type=\"text/javascript\" src=\"/js/page/appAdd.js\"></script>\n");
      out.write("\t</head>\n");
      out.write("\t<script>\n");
      out.write("        var user = \"");
      ...
      out.write("\t\t\t\t\t<form id=\"addAppForm\" action=\"/app/addApp\">\n");
      out.write("\t\t\t\t\t\t<fieldset>\n");
      out.write("\t\t\t\t\t\t\t<legend>应用信息</legend>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"control-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"control-label\" for=\"input01\">名称</label>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"controls\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"input-xlarge\" id=\"input01\" name = \"appName\"/>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"control-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"control-label\" for=\"input01\">公司</label>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"controls\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"input-xlarge\" id=\"input01\" name = \"acompany\" />\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"control-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"control-label\" for=\"textarea\">描述</label>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"controls\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<textarea class=\"input-xlarge\" id=\"textarea\" rows=\"4\" name = \"adesc\"></textarea>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</fieldset>\n");
      out.write("\t\t\t\t\t</form>\n");
      out.write("                    <div class=\"form-actions\">\n");
      out.write("\t\t\t\t\t    <button type=\"submit\" class=\"btn btn-primary\" onclick=\"addSubmit()\">Save</button><div class = \"myinterval\"></div><button class=\"btn\" onclick=\"addCancel()\">Cancel</button>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t </div>\n");
      out.write("\t\t\t</div>\n");
