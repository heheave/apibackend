 ...
 * Generated at: 2017-11-23 10:18:56 UTC
...
public final class userList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("        <script type=\"text/javascript\" src=\"/js/page/userList.js\"></script>\n");
      out.write("\t</head>\n");
      out.write("\t<script>\n");
      out.write("        var user = \"");
      ...
      out.write("\t\t\t\t\t\t\t\t<a href=\"#\"><i class=\"icon-user\"></i>用户列表</a>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t<li>\n");
      ...
      out.write("\n");
      out.write("                    </ul>\n");
      out.write("                    <div class=\"well blank-slate\">\n");
      out.write("                            <a id = \"toggle-a\" href=\"#new-device-code\" class=\"btn btn-primary\"><i class=\"icon-plus icon-white\"></i>为用户添加应用</a>\n");
      out.write("                        </div>\n");
      out.write("                        <div id=\"new-device-code\" class=\"form-horizontal hidden\">\n");
      out.write("                        <form id = \"userAppAdd\" action=\"\">\n");
      out.write("    \t\t\t\t\t\t<fieldset>\n");
      out.write("    \t\t\t\t\t\t\t<legend>应用分配</legend>\n");
      out.write("    \t\t\t\t\t\t\t<div class=\"control-group\">\n");
      out.write("    \t\t\t\t\t\t\t\t<label class=\"control-label\" for=\"seluid\">用户</label>\n");
      out.write("    \t\t\t\t\t\t\t\t<div class=\"controls\">\n");
      out.write("    \t\t\t\t\t\t\t\t\t<select id=\"seluid\" style=\"width:285px\" name= \"uid\"></select>\n");
      out.write("    \t\t\t\t\t\t\t\t</div>\n");
      out.write("    \t\t\t\t\t\t\t</div>\n");
      out.write("    \t\t\t\t\t\t\t<div class=\"control-group\">\n");
      out.write("    \t\t\t\t\t\t\t\t<label class=\"control-label\" for=\"selaid\">应用</label>\n");
      out.write("    \t\t\t\t\t\t\t\t<div class=\"controls\">\n");
      out.write("    \t\t\t\t\t\t\t\t\t<select id=\"selaid\" style=\"width:285px\" name= \"aid\"></select>\n");
      out.write("    \t\t\t\t\t\t\t\t</div>\n");
      out.write("    \t\t\t\t\t\t\t</div>\n");
      out.write("    \t\t\t\t\t\t</fieldset>\n");
      out.write("    \t\t\t\t\t</form>\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /views/userList.jsp(144,9) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/views/userList.jsp(144,9) '${ulist}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${ulist}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    // /views/userList.jsp(144,9) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
