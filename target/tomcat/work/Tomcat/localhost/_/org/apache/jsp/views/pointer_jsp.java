 ...
 * Generated at: 2017-11-15 08:21:56 UTC
...
public final class pointer_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("        <script type=\"text/javascript\" src=\"/js/page/pointer.js\"></script>\n");
      out.write("\n");
      out.write("\t</head>\n");
      out.write("\t<script>\n");
      out.write("   　    var user = \"");
      ...
      out.write("                                \t    </li>\n");
      out.write("                                \t    <li>\n");
      out.write("                                \t\t    <a href=\"/page/forward?page=devicecode\">设备配置</a>\n");
      out.write("                                \t    </li>\n");
      out.write("                                    </ul>\n");
      out.write("                                </li>\n");
      out.write("\t\t\t\t\t\t\t</ul>\n");
      ...
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"/user/getUsers\"><i class=\"icon-th\"></i>应用列表</a>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"/page/forward?page=userAdd\"><i class=\"icon-plus\"></i>添加应用</a>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\n");
      out.write("                            <li class=\"nav-header\">\n");
      out.write("\t\t\t\t\t\t\t    设备管理\n");
      ...
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"/page/forward?page=devicecode\"><i class=\"icon-wrench\"></i>设备配置</a>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      ...
      out.write("                    \t\t\t\t\t\t<fieldset>\n");
      out.write("                    \t\t\t\t\t\t\t<legend>创建逻辑设备</legend>\n");
      ...
      out.write("                                        \t\t\t\t\t\t<tbody>\n");
      out.write("                                        \t\t\t\t\t\t\t<tr>\n");
      out.write("                                        \t\t\t\t\t\t\t\t<td><a>Nike.com Redesign</a></td>\n");
      out.write("                                        \t\t\t\t\t\t\t\t<td>Monsters Inc</td>\n");
      out.write("                                        \t\t\t\t\t\t\t</tr>\n");
      out.write("                                                                    <tr>\n");
      out.write("                                        \t\t\t\t\t\t\t\t<td><a>Nike.com Redesign</a></td>\n");
      out.write("                                        \t\t\t\t\t\t\t\t<td>Monsters Inc</td>\n");
