	...
	<body>
        <div class="container">
			...
			<div class="row">
                ...
                <div class="span9" id = "pointerDetail" style = "display:none">
					<h2>
                        创建逻辑设备
                    </h2>
                ...
                <div class="span9" id = "pointerDetail1" style = "display:none">
                    <h1>
						逻辑设备详情
					</h1>
					<table class="table table-bordered table-striped">
						...
						<tbody>
						    <tr><td>逻辑设备名称</td><td id = "pname"></td></tr>
							<tr><td>设备码</td><td id = "pdcode"></td></tr>
							<tr><td>绑定字段</td><td id = "pbindhash"></td></tr>
							<tr><td>计算规则</td><td id = "pcalculate"></td></tr>
							<tr><td>输出描述</td><td id = "poutdesc"></td></tr>
							<tr><td>输出类型</td><td id = "pouttype"></td></tr>
							<tr><td>均值类型</td><td id = "pavg"></td></tr>
							<tr><td>输出单位</td><td id = "poutunit"></td></tr>
							<tr><td>设备描述</td><td id = "pdesc"></td></tr>
							<tr><td>绑定App</td><td id = "padd"></td></tr>
						</tbody>
					</table>
                ...
                <script>
					    var dccode = getQueryString("dccode")
					    if (!dccode) {
					    $("#pointerDetail").hide()
                        $("#pointerList").show()
