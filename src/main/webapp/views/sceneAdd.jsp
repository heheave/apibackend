...
<html lang="en"><!--<![endif]--> 
	<head>
        ...
        <script type="text/javascript" src="/js/page/sceneAdd.js"></script>
	</head>
	<script>
	...
	<body>
        <div class="container">
						...
						<div class="nav-collapse">
							<ul class="nav">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                	    <li>
                                		    <a href="/page/forward?page=devicelist">设备码列表</a>
                                	    </li>
                                	    <li>
			...
			<div class="row">
				<div class="span3">
					<div class="well" style="padding: 8px 0;">
						<ul class="nav nav-list">
							...
							<li>
								<a href="/page/forward?page=devicelist"><i class="icon-barcode"></i>设备码列表</a>
							</li>
							<li>
                ...
                <div class="span9" style = "display">
					<h2>场景列表</h2>
					<ul class="thumbnails" id = "applist-ul"></ul>
				<a id = "toggle-a" href="#new-device-code"><i class="icon-plus"></i>新建场景</a>
                <div id="new-device-code" class="form-horizontal hidden">
                    <form id="addAppForm" action="/app/scene-add">
						<fieldset>
							<legend>场景信息</legend>
							<input type="text" class="input-xlarge" id="said" name = "said" style = "display:none"/>
							<div class="control-group">
								<label class="control-label" for="input01">名称</label>
								<div class="controls">
									<input type="text" class="input-xlarge" id="input01" name = "sname"/>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="textarea">描述</label>
								<div class="controls">
									<textarea class="input-xlarge" id="textarea" rows="4" name = "sdesc"></textarea>
								</div>
							</div>
						</fieldset>
					</form>
					<div class="control-group">
                        <label class="control-label" for="fileInput">背景</label>
                    	<div class="controls">
                    	    <input class="input-file" accept=".jpg,.png,.gif,.jpeg" name = "file" id="fileUpload" type="file" onchange="uploadFile(this)"/>
                        </div>
                    </div>
