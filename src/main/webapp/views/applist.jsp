	...
	<body>
        <div class="container">
							...
							<ul class="nav">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                	    ...
                                	    <li>
                                		    <a href="/page/forward?page=devicecode">设备列表</a>
                                	    </li>
                                    </ul>
                                </li>
							</ul>
			...
			<div class="row">
				<div class="span3">
					<div class="well" style="padding: 8px 0;">
						<ul class="nav nav-list">
							...
							<li class="active">
								<a href="#"><i class="icon-th"></i>应用列表</a>
							</li>
							<li>
				...
				<div class="span9" id = "appList">
					<ul class="files zebra-list">
					    <c:forEach items="${alist}" var="a">
                        <li>
                    	    <i class="icon-th-large"></i>
                    	    <a class="title" href="/page/forward?page=sceneAdd&appId=${a.appId}">
                    	        名称: ${a.appName}
                    	    </a> <span class="meta">公司: <em>${a.acompany}</em><br/>描述: <em>${a.adesc}</em><br/>创建于: <em>${a.crtTime}</em></span>
                        </li>
                        </c:forEach>
                    </ul>
				</div>
