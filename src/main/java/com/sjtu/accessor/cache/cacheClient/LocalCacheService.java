package com.sjtu.accessor.cache.cacheClient;

import com.sjtu.accessor.cache.CEntry;
import com.sjtu.accessor.cache.CacheService;
import com.sjtu.accessor.cache.DeserEntrier;
import com.sjtu.accessor.cache.rabbitmq.RabbitCListener;
import com.sjtu.accessor.cache.rabbitmq.RabbitConsumer;
...
public class LocalCacheService<T extends DeserEntrier> implements CacheService {
    ...
    public LocalCacheService(String cacheDesc,
        ...
        this.rabbitConsumer = new RabbitConsumer(host, port, queueName);
        this.deser = deser;
    }
