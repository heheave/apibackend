...
//
//    //private DSLockUtil dsLockClient = DSLockUtil.instance(conf);
//
//    @Autowired
...
//        String lockPath = conf.getStringOrElse(V.DSLOCK_ZK_PATH);
//        //String lockedPath = dsLockClient.tryLock(lockPath);
//        if (lockedPath != null) {
//            try {
//                try {
//                    //ZooKeeper zk = dsLockClient.zk();
//                    String updatePath = conf.getStringOrElse(V.DSLOCK_ZK_UPDATE_PATH);
...
//            } finally {
//                try {
//                    Thread.sleep(conf.getLongOrElse(V.DSLOCK_ZK_LOCK_MINIMUM));
